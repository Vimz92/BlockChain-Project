...
import logo from '../assets/robinhood-removebg.png'
...
const styles ={
 ...
 searchWrapper: 'flex flex-1 bg-red',
 searchInputContainer: 'text-white items-center flex flex-1 -ml-64 border border-gray-400 mr-64 hover:bg-[yellow] duration-300 p-3 rounded-lg',
 searchIcon: 'text-gray-400 text-3x1 mr-3',
 searchInputWrapper: 'text-gray-400 text-lg w-full',
 searchInput: 'bg-transparent outline-none w-full',
 rightHeader:'flex items-center justify-end gap-10',
 menuItem: 'cursor-pointer text-white font-bold hover:text-green-500 duration-300',
}

//make dynamic later
const isAuthenticated = false
const formattedAccount= "0x67...D2B0"
